...
check_link "$HOME/.claude/CLAUDE.md"     "$VAULT/CLAUDE.md"     "~/.claude/CLAUDE.md"
check_link "$HOME/.claude/settings.json" "$VAULT/settings.json" "~/.claude/settings.json"
check_link "$HOME/.claude/skills"        "$VAULT/skills"        "~/.claude/skills"
check_link "$HOME/.claude/output-styles" "$VAULT/output-styles" "~/.claude/output-styles"
check_link "$HOME/.claude/hooks"         "$VAULT/hooks"         "~/.claude/hooks"
check_link "$HOME/.claude/agents"        "$VAULT/agents"        "~/.claude/agents"
echo ""
